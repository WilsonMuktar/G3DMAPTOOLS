...
<body>
    <div id="title" name="title" style="cursor: move; border:none;">
      <div id='name'>Legend</div>
		...
		<table id="legendlist">
			<tbody id="legend">
				<tr>
					<td><div id="levelmax"></div></td>
					<td><br/><div id="valuemax" style="margin-top:-12px;margin-left:10px;"\></td>
				</tr>
				<tr>
					<td><div id="levelmin"></div></td>
					<td><br/><div id="valuemin" style="margin-top:-12px;margin-left:10px;"\></td>
				</tr>
				<tr><td></td></tr>
			</tbody>
		</table>
	...
	<script>
		...
		function resizedialog(){
			...
			parent.document.getElementById('dialogbase2').style.top = "70%";
		...
		$(window).ready(
			function(){
				...
				//Set Legend Color;
				document.getElementById('levelmax').setAttribute("style","background-color:"+parent.colorhigh);
				document.getElementById('levelmin').setAttribute("style","background-color:"+parent.colorlow);
				document.getElementById('valuemax').innerHTML = parent.G3DMAP.selectingtable;//parent.colormodemaxvalue;
				document.getElementById('valuemin').innerHTML = "not "+parent.G3DMAP.selectingtable;//parent.colormodeminvalue;
			}
		);
	</script>
